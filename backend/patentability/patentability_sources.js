...
const PATENTABILITY_SOURCES = [
  ...
  { id:'uspto-patentsview',  name:'USPTO Open Data Portal (ex-PatentsView)', url:'https://api.uspto.gov/api/v1/patent/applications/search',                type:'api',  tier:'A', priority:'CRITICAL', coverage:['US'],          pillars:['novelty','non_obvious'], docType:'patent',            auth:'api-key (X-Api-Key)', note:'11M+ US patents; PatentsView retired 2025-05-01, migrated to data.uspto.gov; 45 req/min' },
